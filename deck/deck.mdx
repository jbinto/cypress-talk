...
<ul>
  <Appear>
    ...
    <li>They only tested their public APIs - test suite did not have to change</li>
    <li><p>For a web application, <em>the user interface</em> is the public API</p></li>
    <li>⏭</li>
  </Appear>
</ul>
...
<Appear>
  ...
  <li><small>(* if you follow the rules)</small></li>
  <li>⏭</li>
</Appear>
...
<ul>
  <Appear>
    ...
    <li>But in order to guarantee reliability, you need to follow rules</li>
