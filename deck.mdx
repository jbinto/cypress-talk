...
<ul>
  <Appear>
    <li>🚧 The internals of React were entirely rewritten between React 15 and React 16</li>
...
<ul>
  <li>🚧 The internals of React were entirely rewritten between React 15 and React 16</li>
  <li>👩‍🔬 They only tested their public APIs
    <ul>
  ...
  <Appear>
    <li>💻 For a web application, <em>the user interface</em> is the public API</li>
    <li>⏭</li>
  </Appear>
</ul>
...
<Appear>
  ...
  <li>👨‍⚖️ (* if you follow the rules)</li>
  <li>⏭</li>
</Appear>
...
<ul>
  <Appear>
    <li>🔤 <a href="https://docs.cypress.io/guides/core-concepts/introduction-to-cypress.html#Cypress-Can-Be-Simple-Sometimes">It's simple (sometimes)</a></li>
    <li>👮‍♂️  But in order to guarantee reliability, you need to follow rules</li>
    <li>👨‍🎓 You may need to unlearn the way you've tested in other environments</li>
...
<Appear>
  ...
  <li>⚙️ Write arbitrary tasks in Node with <code>cy.task()</code></li>
